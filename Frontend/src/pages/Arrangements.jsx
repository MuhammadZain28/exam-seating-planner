...
import { Download, CircleCheckBig, Share, Trash2 } from 'lucide-react';
import { ExistingArrangements, deleteArrangement, exportXlsx } from '../utils/seating';
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className='flex items-center'>
                <button
                  ...
                  className="bg-white border-2 border-indigo-600 text-indigo-600 px-4 py-2 rounded-lg hover:bg-indigo-700 hover:text-white  transition-all duration-300"
                >
                ...
                <button
                    ...
                    className="bg-white border-2 border-indigo-600 text-indigo-600 px-4 py-2 rounded-lg hover:bg-indigo-700 hover:text-white ml-4 transition-all duration-300"
                >
